...
from grt.sensors.alignment_sensor import AlignmentSensor
...
l_ultrasonic = Ultrasonic(0)
r_ultrasonic = Ultrasonic(1)
...
ultrasonic_align_macro = UltrasonicAlignMacro(dt, )
...
crazy_auto = CrazyAuto(talon_arr, dt, imu, l_ultrasonic, r_ultrasonic, left_switch, right_switch)


sp = SensorPoller((gyro, left_encoder, right_encoder, elevator_encoder, l_ultrasonic, r_ultrasonic))
...
alignment_sensor = AlignmentSensor(dt, l_ultrasonic, r_ultrasonic, left_switch, right_switch, driver_stick)
hid_sp = SensorPoller((driver_stick, xbox_controller, alignment_sensor))  # human interface devices
